...
namespace Admin
{
    internal class dbHelper
    {
        ...
        private static string strConnString = "Data Source=DESKTOP-A19S771\\SQLEXPRESS;Initial Catalog=GrifindoLeaveManagement;Integrated Security=True;Encrypt=False";
